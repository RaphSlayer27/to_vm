...
wget -O /etc/httpd/conf.d/phpMyAdmin.conf https://www.ecualinux.com/ispconfig7/phpMyAdmin.conf
wget -O /etc/httpd/conf.d/ssl.conf https://www.ecualinux.com/ispconfig7/ssl.conf
wget -O /etc/phpMyAdmin/config.inc.php https://www.ecualinux.com/ispconfig7/config.myadmin
wget -O /etc/freshclam.conf https://www.ecualinux.com/ispconfig7/freshclam.conf
wget -O /etc/php.ini https://www.ecualinux.com/ispconfig7/php.txt
...
#wget -q -O /etc/suphp.conf https://www.ecualinux.com/ispconfig7/suphp.conf
#wget  -q -O /etc/httpd/conf.d/mod_suphp.conf https://www.ecualinux.com/ispconfig7/mod_suphp.conf
wget  -q -O /etc/httpd/conf.d/php.conf https://www.ecualinux.com/ispconfig7/php.conf
...
wget -q -O /etc/named.conf https://www.ecualinux.com/ispconfig7/named.conf
touch /etc/named.conf.local
#fail2ban
wget -q -O /etc/fail2ban/jail.d/00-firewalld.conf https://www.ecualinux.com/ispconfig7/00-firewalld.conf
wget -q -O /etc/fail2ban/jail.d/postfix.local https://www.ecualinux.com/ispconfig7/postfix.local
wget -q -O /etc/fail2ban/jail.d/sshd.local https://www.ecualinux.com/ispconfig7/sshd.local

systemctl enable --now named.service
systemctl enable --now fail2ban.service

touch /var/lib/mailman/data/aliases
wget  -q -O /etc/roundcubemail/config.inc.php https://www.ecualinux.com/ispconfig7/config.rc
wget  -q -O /tmp/rcm.sql https://www.ecualinux.com/ispconfig7/rcm.sql

echo "Entre la clave de root de MySQL"
mysql -u root -p < /tmp/rcm.sql

wget -O /etc/httpd/conf.d/roundcubemail.conf https://www.ecualinux.com/ispconfig7/roundcubemail.conf.local
...
php -q install.php
wget -O /usr/lib/mailman/Mailman/mm_cfg.py https://www.ecualinux.com/ispconfig7/mm_cfg.py
...
wget -O /etc/postfix/master.cf https://www.ecualinux.com/ispconfig7/master.cf
wget -O /etc/postfix/main.cf https://www.ecualinux.com/ispconfig7/main.cf
...
wget -O /etc/sysconfig/postgrey https://www.ecualinux.com/ispconfig7/postgrey.txt
...
#wget -O /usr/local/ispconfig/server/conf-custom/vhost.conf.master https://www.ecualinux.com/ispconfig7/vhost.conf.master
